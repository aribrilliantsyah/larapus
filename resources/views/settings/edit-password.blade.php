		...
		<div class="col-md-12">
			...
			<div class="panel panel-custom">
				<div class="panel-heading panel-heading-custom">
					<h2 class="panel-title panel-title-custom"><i class="fa fa-pencil"></i> <i class="fa fa-lock"></i> Ubah Password</h2>
				</div>
				<div class="panel-body">
					 {!! Form::open(['url'=>'/settings/password','method'=>'post','class'=>'form-horizontal']) !!}
